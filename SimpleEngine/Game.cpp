...
Game::Game(HINSTANCE hInstance) : mhGameInst(hInstance)
{
...
HINSTANCE Game::GameInst()const
{
    return mhGameInst;
}

HWND Game::MainWnd()const
{
    return mhMainWnd;
}
...
bool Game::Get4xMsaaState()const
{
    return m4xMsaaState;
}

void Game::Set4xMsaaState(bool value)
{
...
bool Game::InitMainWindow()
{
    ...
    mhMainWnd = CreateWindow(L"MainWnd", mMainWndCaption.c_str(),
        WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, width, height, 0, 0, mhGameInst, 0);
    if (!mhMainWnd)
    {
